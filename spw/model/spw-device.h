 ...
 */
class SpWDevice : public NetDevice
{
  public:
    /**
    ...
    SpWDevice& operator=(const SpWDevice&) = delete;
    SpWDevice(const SpWDevice&) = delete;
